      ...
      <div className="container mx-auto max-w-lg">
        ...
        <Accordion type="multiple">
          {questions.map((question, index) => (
            <AccordionItem key={index} value={`item-${index}`} className="py-2">
              <AccordionTrigger className="md:py-5 md:text-lg">{question.title}</AccordionTrigger>
              <AccordionContent className="md:pb-6 mt-2">{question.answer}</AccordionContent>
            </AccordionItem>
          ))}
        </Accordion>
        <div className="mx-auto mt-12 max-w-md text-center md:mt-18 lg:mt-20">
          ...
          <div className="mt-6 md:mt-8">
            <Button variant="outline" className='z-50 w-fit mx-auto mt-4 bg-transparent text-black dark:text-white border-black dark:border-white'>
                <a href='https://wa.me/+963948911648' target="_blank" rel="noopener noreferrer">contact me</a>
